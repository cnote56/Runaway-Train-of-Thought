...
Your topic asks what if a 3rd party candidate became a contender for the
presidency because the candidate promises only to serve one term and
dissolve the party. The platform of the party is very socially
democratic and is as follows:
...
This is accomplished by a tax of 99% on all earnings over $1billion a
year. All corporation pay this tax and there is no way to avoid it. A
technological maguffin would be a good idea to use here. Feel free to
develop some of the math that this would need and use it in a scene to
win over the reader to like the idea.

The plot for the storymust conform to the electoral calendar for US
...
There is one plot twist that must be followed. The candidate is
assassinated sometime in the plot. Consider an in-medias res beginning
where this occurs, and the story is told to fill in the chain of events.

You need to think about a subplot for the bad guy or assassin’s subplot
to show the villain or the assassin. Consider the plot of Bruce Willis's
film The Day of the Jackal for an idea on how to follow the bad guy in a
